export const ATTACK_CATALOG = Object.freeze({
  sword: Object.freeze({
    ...
    steps: Object.freeze([
      ...
      Object.freeze({ id: 'sword-whirl', profile: 'attack6', damage: 1, knockback: 7.2, holdOnly: true, duration: 1.16, animation: 'attack-melee-right', chargeAnimation: 'holding-both', chargeEnd: 0.56, animationSpeed: 1.34, hitStart: 0.67, hitEnd: 0.9, rangeCells: 1.28, cone: -1 })
    ])
  }),
  spear: Object.freeze({
    id: 'spear',
    ...
    steps: Object.freeze([
      ...
      Object.freeze({ id: 'spear-whirl', profile: 'attack6', damage: 1, knockback: 9.4, holdOnly: true, duration: 1.24, animation: 'attack-melee-right', chargeAnimation: 'holding-both', chargeEnd: 0.58, animationSpeed: 1.2, hitStart: 0.69, hitEnd: 0.91, rangeCells: 1.46, cone: -1 })
    ])
  })
});
